/**
 * Página para listar pagos con filtros
 */
...
const PagosList = () => {
  ...
  const loadPagos = async () => {
    try {
      ...
      const data = await fetchPagos(filtros);
      setPagos(data);
    } catch (err) {
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Pagos Registrados</h1>
        <p className="text-gray-600">Historial de pagos procesados con Stripe</p>
      </div>
